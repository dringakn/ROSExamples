...
#include <opencv-3.3.1-dev/opencv2/calib3d/calib3d.hpp>       // for homography
#include <opencv-3.3.1-dev/opencv2/features2d/features2d.hpp> // SURF Features
#include <opencv-3.3.1-dev/opencv2/opencv.hpp>
#include <sensor_msgs/Image.h>
// #include <opencv-3.3.1-dev/opencv2/nonfree/features2d.hpp> // SIFT Features
